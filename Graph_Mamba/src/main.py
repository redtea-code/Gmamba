...
from Graph_Mamba.src.dataset import *
from Graph_Mamba.src.models import *
from Graph_Mamba.src.gnn_classification import *
...
def parse_arguments(args=None):
	...
	####### Dataset
	# parser.add_argument('--dataset', type=str, default='toxicity')
	...
	parser.add_argument('--feature_extractor_dims', nargs='+', default=[100, 256, 512], action=ParseAction, # use last dimnsion of 10 following the paper "Promises and perils of DKL"
	...
	####### GCondNet settings
	parser.add_argument('--winit_initialisation', type=str, choices=['pca', 'wl', 'nmf', 'gcondnet'], default="gcondnet")
	parser.add_argument('--winit_first_layer_interpolation_scheduler', type=str, choices=['linear'], default='linear')
	...
	parser.add_argument('--winit_graph_connectivity_type', type=str, choices=['random', 'sparse-relative-distance', 'knn'], default='knn',
	...
	####### Wandb logging
	parser.add_argument('--logger', type=str, default='csv', choices=['wandb', 'csv'], help='logger for logging the results',)
	parser.add_argument('--experiment_name', type=str, default='GCondNet_KNN', help='Name for the experiment')
